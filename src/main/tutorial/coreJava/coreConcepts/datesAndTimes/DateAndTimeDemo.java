package main.tutorial.coreJava.coreConcepts.datesAndTimes;
...
public class DateAndTimeDemo {
    public static void main(String[] args) throws Exception {
        ...
        DateFormat simpleDateFormat = new SimpleDateFormat("MM d yyyy HH mm ss");
         ...
         */
        System.out.println("==== Epoch timestamp to date ====");
        Date date1 = new Date(1487800378);
