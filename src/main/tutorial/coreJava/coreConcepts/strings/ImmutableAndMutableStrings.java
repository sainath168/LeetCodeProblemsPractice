...
public class ImmutableAndMutableStrings {
    public static void main(String[] args) {
        ...
        // string object is created and placed in string pool and returned reference of "ava" to variable "a"
        // and then same reference is assigned to variable "b", no new memory allocated for "b"
